submodule (parse_mod) parse_sub
  ...
  & [ lr_table( [ REJECT, REJECT, SHIFT_7, REJECT, REJECT, REJECT, &
  &               SHIFT_5, REJECT, SHIFT_10, SHIFT_13, SHIFT_8, &
  &               SHIFT_9, SHIFT_12, SHIFT_11, REJECT, &
  &               GOTO_2, GOTO_4, GOTO_6, GOTO_1, GOTO_3] ), &
  &   lr_table( [ ACCEPT, REJECT, REJECT, REJECT, REJECT, REJECT, &
  &               REJECT, REJECT, REJECT, REJECT, REJECT, REJECT, &
  &               REJECT, REJECT, REJECT, REJECT, REJECT, REJECT, &
  &               REJECT, REJECT ] ), &
  &   lr_table( [ REDUCE_1, REJECT, REJECT, REJECT, REJECT, &
  &               SHIFT_13, SHIFT_15, REJECT, REJECT, &
  &               REJECT, REJECT, REJECT, REJECT, REJECT, REJECT, &
  &               REJECT, REJECT, REJECT, REJECT, &
  &               REJECT ] ), &
  &   lr_table( [ REDUCE_4, SHIFT_18, REJECT, REDUCE_4, SHIFT_16, &
  &               REDUCE_4, REDUCE_4, SHIFT_17, &
  &               REJECT, REJECT, REJECT, REJECT, REJECT, REJECT, &
  &               REJECT, REJECT, REJECT, REJECT, &
  &               REJECT, REJECT ] ), &
  &   lr_table( [ REDUCE_5, REDUCE_5, REDUCE_5, REDUCE_5, REDUCE_5, &
  &               REDUCE_5, REDUCE_5, REDUCE_5, REDUCE_5, REDUCE_5, &
  &               REDUCE_5, REDUCE_5, REDUCE_5, REDUCE_5, REJECT, &
  &               REJECT, REJECT, REJECT, REJECT, REJECT ] ), &
  &   lr_table( [ REJECT, REJECT, SHIFT_7, REJECT, REJECT, REJECT, &
  &               SHIFT_5, REJECT, SHIFT_10, SHIFT_13, &
  &               SHIFT_8, SHIFT_9, SHIFT_12, SHIFT_11, REJECT, &
  &               REJECT, GOTO_19, GOTO_6, REJECT, REJECT ] ), &
  &   lr_table( [ REJECT, REJECT, SHIFT_20, REJECT, REJECT, REJECT, &
  &               REJECT, REJECT, REJECT, REJECT, &
  &               REJECT, REJECT, REJECT, REJECT, REJECT, &
  &               REJECT, REJECT, REJECT, REJECT, REJECT ] ), &
  &   lr_table( [ REJECT, REJECT, SHIFT_7, REJECT, REJECT, REJECT, &
  &               SHIFT_5, REJECT, SHIFT_10, SHIFT_13, &
  &               SHIFT_8, SHIFT_9, SHIFT_12, SHIFT_11, REJECT, &
  &               GOTO_21, GOTO_4, GOTO_6, REJECT, GOTO_3 ] ), &
  &   lr_table( [ REDUCE_6, REDUCE_6, REDUCE_6, REDUCE_6, REDUCE_6, &
  &               REDUCE_6, REDUCE_6, REDUCE_6, REDUCE_6, REDUCE_6, &
  &               REDUCE_6, REDUCE_6, REDUCE_6, REDUCE_6, REJECT, &
  &               REJECT, REJECT, REJECT, REJECT, REJECT ] ), &
  &   lr_table( [ REDUCE_7, REDUCE_7, REDUCE_7, REDUCE_7, REDUCE_7, &
  &               REDUCE_7, REDUCE_7, REDUCE_7, REDUCE_7, REDUCE_7, &
  &               REDUCE_7, REDUCE_7, REDUCE_7, REDUCE_7, REJECT, &
  &               REJECT, REJECT, REJECT, REJECT, REJECT ] ), &
  &   lr_table( [ REDUCE_8, REDUCE_8, REDUCE_8, REDUCE_8, REDUCE_8, &
  &               REDUCE_8, REDUCE_8, REDUCE_8, REDUCE_8, REDUCE_8, &
  &               REDUCE_8, REDUCE_8, REDUCE_8, REDUCE_8, REJECT, &
  &               REJECT, REJECT, REJECT, REJECT, REJECT ] ), &
  &   lr_table( [ REDUCE_9, REDUCE_9, REDUCE_9, REDUCE_9, REDUCE_9, &
  &               REDUCE_9, REDUCE_9, REDUCE_9, REDUCE_9, REDUCE_9, &
  &               REDUCE_9, REDUCE_9, REDUCE_9, REDUCE_9, REJECT, &
  &               REJECT, REJECT, REJECT, REJECT, REJECT ] ), &
  &   lr_table( [ REDUCE_10, REDUCE_10, REDUCE_10, REDUCE_10, &
  &               REDUCE_10, REDUCE_10, REDUCE_10, REDUCE_10, &
  &               REDUCE_10, REDUCE_10, &
  &               REDUCE_10, REDUCE_10, REDUCE_10, REDUCE_10, REJECT, &
  &               REJECT, REJECT, REJECT, REJECT, REJECT ] ), &
  &   lr_table( [ REDUCE_11, REDUCE_11, REDUCE_11, REDUCE_11, &
  &               REDUCE_11, REDUCE_11, REDUCE_11, REDUCE_11, &
  &               REDUCE_11, REDUCE_11, &
  &               REDUCE_11, REDUCE_11, REDUCE_11, REDUCE_11, REJECT, &
  &               REJECT, REJECT, REJECT, REJECT, REJECT ] ), &
  &   lr_table( [ REJECT, REJECT, SHIFT_7, REJECT, REJECT, REJECT, &
  &               SHIFT_5, REJECT, SHIFT_10, SHIFT_13, &
  &               SHIFT_8, SHIFT_9, SHIFT_12, SHIFT_11, REJECT, &
  &               REJECT, GOTO_4, GOTO_6, REJECT, GOTO_22 ] ), &
  &   lr_table( [ REJECT, REJECT, SHIFT_7, REJECT, REJECT, REJECT, &
  &               SHIFT_5, REJECT, SHIFT_10, SHIFT_13, &
  &               SHIFT_8, SHIFT_9, SHIFT_12, SHIFT_11, REJECT, &
  &               REJECT, GOTO_4, GOTO_6, REJECT, GOTO_23 ] ), &
  &   lr_table( [ REJECT, REJECT, SHIFT_7, REJECT, REJECT, REJECT, &
  &               SHIFT_5, REJECT, SHIFT_10, SHIFT_13, &
  &               SHIFT_8, SHIFT_9, SHIFT_12, SHIFT_11, REJECT, &
  &               REJECT, GOTO_24, GOTO_6, REJECT, REJECT ] ), &
  &   lr_table( [ REJECT, REJECT, SHIFT_7, REJECT, REJECT, REJECT, &
  &               SHIFT_5, REJECT, SHIFT_10, SHIFT_13, &
  &               SHIFT_8, SHIFT_9, SHIFT_12, SHIFT_11, REJECT, &
  &               REJECT, GOTO_25, GOTO_6, REJECT, REJECT ] ), &
  &   lr_table( [ REJECT, REJECT, SHIFT_7, REJECT, REJECT, REJECT, &
  &               SHIFT_5, REJECT, SHIFT_10, SHIFT_13, &
  &               SHIFT_8, SHIFT_9, SHIFT_12, SHIFT_11, REJECT, &
  &               REJECT, GOTO_26, GOTO_6, REJECT, REJECT ] ), &
  &   lr_table( [ REDUCE_12, REDUCE_12, REDUCE_12, REDUCE_12, &
  &               REDUCE_12, REDUCE_12, REDUCE_12, REDUCE_12, &
  &               REDUCE_12, REDUCE_12, &
  &               REDUCE_12, REDUCE_12, REDUCE_12, REDUCE_12, REJECT, &
  &               REJECT, REJECT, REJECT, REJECT, REJECT ] ), &
  &   lr_table( [ REJECT, REJECT, SHIFT_7, REJECT, REJECT, REJECT, &
  &               SHIFT_5, REJECT, SHIFT_10, SHIFT_13, &
  &               SHIFT_8, SHIFT_9, SHIFT_12, SHIFT_11, REJECT, &
  &               GOTO_27, GOTO_4, GOTO_6, REJECT, GOTO_3 ] ), &
  &   lr_table( [ REJECT, REJECT, REJECT, SHIFT_28, REJECT, &
  &               SHIFT_14, SHIFT_15, REJECT, REJECT, REJECT, &
  &               REJECT, REJECT, REJECT, REJECT, REJECT, &
  &               REJECT, REJECT, REJECT, REJECT, REJECT ] ), &
  &   lr_table( [ REDUCE_2, SHIFT_18, REJECT, REDUCE_2, SHIFT_16, &
  &               REDUCE_2, REDUCE_2, SHIFT_17, REJECT, &
  &               REJECT, REJECT, REJECT, REJECT, REJECT, REJECT, &
  &               REJECT, REJECT, REJECT, REJECT, REJECT ] ), &
  &   lr_table( [ REDUCE_2, SHIFT_18, REJECT, REDUCE_3, SHIFT_16, &
  &               REDUCE_3, REDUCE_3, SHIFT_17, REJECT, &
  &               REJECT, REJECT, REJECT, REJECT, REJECT, REJECT, &
  &               REJECT, REJECT, REJECT, REJECT, REJECT ] ), &
  &   lr_table( [ REDUCE_13, REDUCE_13, REDUCE_13, REDUCE_13, &
  &               REDUCE_13, REDUCE_13, REDUCE_13, REDUCE_13, &
  &               REDUCE_13, REDUCE_13, &
  &               REDUCE_13, REDUCE_13, REDUCE_13, REDUCE_13, REJECT, &
  &               REJECT, REJECT, REJECT, REJECT, REJECT ] ), &
  &   lr_table( [ REDUCE_14, REDUCE_14, REDUCE_14, REDUCE_14, &
  &               REDUCE_14, REDUCE_14, REDUCE_14, REDUCE_14, &
  &               REDUCE_14, REDUCE_14, &
  &               REDUCE_14, REDUCE_14, REDUCE_14, REDUCE_14, REJECT, &
  &               REJECT, REJECT, REJECT, REJECT, REJECT ] ), &
  &   lr_table( [ REDUCE_15, REDUCE_15, REDUCE_15, REDUCE_15, &
  &               REDUCE_15, REDUCE_15, REDUCE_15, REDUCE_15, &
  &               REDUCE_15, REDUCE_15, &
  &               REDUCE_15, REDUCE_15, REDUCE_15, REDUCE_15, REJECT, &
  &               REJECT, REJECT, REJECT, REJECT, REJECT ] ), &
  &   lr_table( [ REJECT, REJECT, REJECT, SHIFT_29, REJECT, &
  &               SHIFT_14, SHIFT_15, REJECT, REJECT, REJECT, &
  &               REJECT, REJECT, REJECT, REJECT, REJECT, &
  &               REJECT, REJECT, REJECT, REJECT, REJECT ] ), &
  &   lr_table( [ REDUCE_16, REDUCE_16, REDUCE_16, REDUCE_16, &
  &               REDUCE_16, REDUCE_16, REDUCE_16, REDUCE_16, &
  &               REDUCE_16, REDUCE_16, &
  &               REDUCE_16, REDUCE_16, REDUCE_16, REDUCE_16, REJECT, &
  &               REJECT, REJECT, REJECT, REJECT, REJECT ] ), &
  &   lr_table( [ REDUCE_17, REDUCE_17, REDUCE_17, REDUCE_17, &
  &               REDUCE_17, REDUCE_17, REDUCE_17, REDUCE_17, &
  &               REDUCE_17, REDUCE_17, &
  &               REDUCE_17, REDUCE_17, REDUCE_17, REDUCE_17, REJECT, &
  &               REJECT, REJECT, REJECT, REJECT, REJECT ] ), &
  &   lr_table( [ REJECT, REJECT, REJECT, REJECT, REJECT, REJECT, &
  &               REJECT, REJECT, REJECT, REJECT, &
  &               REJECT, REJECT, REJECT, REJECT, REJECT, &
  &               REJECT, REJECT, REJECT, REJECT, REJECT ] ), &
  &   lr_table( [ REJECT, REJECT, REJECT, REJECT, REJECT, REJECT, &
  ...
  & [ goto_table( [ STATE_REJECT, STATE_REJECT, STATE_REJECT, &
  ...
  &               STATE_REJECT, STATE_REJECT, STATE_REJECT, &
  &               STATE_REJECT, STATE_REJECT, STATE_REJECT, &
  &               STATE_19, STATE_6, STATE_REJECT, STATE_REJECT ] ), &
  &   goto_table( [ STATE_REJECT, STATE_REJECT, STATE_REJECT, &
  &               STATE_REJECT, STATE_REJECT, STATE_REJECT, &
  &               STATE_REJECT, STATE_REJECT, STATE_REJECT, &
  &               STATE_REJECT, &
  ...
  &               STATE_REJECT, &
  &               STATE_REJECT, STATE_REJECT, STATE_REJECT, &
  &               STATE_REJECT, STATE_REJECT, STATE_21, STATE_4, &
  &               STATE_6, STATE_REJECT, STATE_3 ] ), &
  &   goto_table( [ STATE_REJECT, STATE_REJECT, STATE_REJECT, &
  &               STATE_REJECT, STATE_REJECT, STATE_REJECT, &
  &               STATE_REJECT, STATE_REJECT, STATE_REJECT, &
  &               STATE_REJECT, &
  ...
  &               STATE_REJECT, STATE_REJECT, STATE_REJECT, &
  &               STATE_REJECT, STATE_REJECT, STATE_REJECT, &
  &               STATE_4, STATE_6, STATE_REJECT, STATE_22 ] ), &
  &   goto_table( [ STATE_REJECT, STATE_REJECT, STATE_REJECT, &
  &               STATE_REJECT, STATE_REJECT, STATE_REJECT, &
  &               STATE_REJECT, STATE_REJECT, STATE_REJECT, &
  &               STATE_REJECT, &
  &               STATE_REJECT, STATE_REJECT, STATE_REJECT, &
  &               STATE_REJECT, STATE_REJECT, STATE_REJECT, &
  &               STATE_4, STATE_6, STATE_REJECT, STATE_23 ] ), &
  &   goto_table( [ STATE_REJECT, STATE_REJECT, STATE_REJECT, &
  &               STATE_REJECT, STATE_REJECT, STATE_REJECT, &
  &               STATE_REJECT, STATE_REJECT, STATE_REJECT, &
  &               STATE_REJECT, &
  &               STATE_REJECT, STATE_REJECT, STATE_REJECT, &
  &               STATE_REJECT, STATE_REJECT, STATE_REJECT, &
  &               STATE_24, STATE_6, STATE_REJECT, STATE_REJECT ] ), &
  &   goto_table( [ STATE_REJECT, STATE_REJECT, STATE_REJECT, &
  &               STATE_REJECT, STATE_REJECT, STATE_REJECT, &
  &               STATE_REJECT, STATE_REJECT, STATE_REJECT, &
  &               STATE_REJECT, &
  &               STATE_REJECT, STATE_REJECT, STATE_REJECT, &
  &               STATE_REJECT, STATE_REJECT, STATE_REJECT, &
  &               STATE_25, STATE_6, STATE_REJECT, STATE_REJECT ] ), &
  &   goto_table( [ STATE_REJECT, STATE_REJECT, STATE_REJECT, &
  &               STATE_REJECT, STATE_REJECT, STATE_REJECT, &
  &               STATE_REJECT, STATE_REJECT, STATE_REJECT, &
  &               STATE_REJECT, &
  &               STATE_REJECT, STATE_REJECT, STATE_REJECT, &
  &               STATE_REJECT, STATE_REJECT, STATE_REJECT, &
  &               STATE_26, STATE_6, STATE_REJECT, STATE_REJECT ] ), &
  &   goto_table( [ STATE_REJECT, STATE_REJECT, STATE_REJECT, &
  &               STATE_REJECT, STATE_REJECT, STATE_REJECT, &
  &               STATE_REJECT, STATE_REJECT, STATE_REJECT, &
  &               STATE_REJECT, &
  ...
  &               STATE_REJECT, &
  &               STATE_REJECT, STATE_REJECT, STATE_REJECT, &
  &               STATE_REJECT, STATE_REJECT, STATE_27, STATE_4, &
  &               STATE_6, STATE_REJECT, STATE_3 ] ), &
  &   goto_table( [ STATE_REJECT, STATE_REJECT, STATE_REJECT, &
  &               STATE_REJECT, STATE_REJECT, STATE_REJECT, &
  &               STATE_REJECT, STATE_REJECT, STATE_REJECT, &
